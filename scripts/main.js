...
var base = Rebase.createClass('https://catch-of-the-daydrew.firebaseio.com');
...
var Order = React.createClass({
  ...
  render: function(){
    ...
    var total = orderIds.reduce((prevTotal, key) => {
      ...
      if(fish && isAvailable){
        return prevTotal + (key=count * parseInt(fish.price) || 0);
      }
      return prevTotal;
    }, 0);
  ...
  renderInventory: function(key){
    ...
    return (
      <div className="fish-edit" key={key}>
        ...
        <teaxtarea valueLink={linkState('fishes.'+ key +'.desc')}></teaxtarea>
